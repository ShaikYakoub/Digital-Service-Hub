        ...
        <div className="flex flex-col gap-4 rounded-lg border bg-white p-8 shadow-lg">
          ...
          <div className="flex flex-col gap-2">
            <form
              action={async () => {
                "use server";
                // For now, social signup will be handled by NextAuth
            ...
            >
              <button
                type="submit"
                disabled
                className="w-full flex items-center justify-center gap-2 rounded border p-2 hover:bg-gray-50 opacity-50 cursor-not-allowed"
              >
